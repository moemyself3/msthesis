...
\Abstract{%
    ...
    Practices of documenting brightness led to observations of variablity.
    The purpose of this project is to create lightcurator a pipeline written in python that creates a
    framework for detecting variable stars by creating a catalogue of stars and light curves of data from eclipsing binary star observations.
The eclipsing binary stars were the main targets in the observations and will be characterized.
Currently, lightcurator is limited to detecting cataloged variable stars from the General Catalogue of Variable Stars (GCVS) and
the Varable Star Index (VSX). The periods and radii of X number of eclipsing binary systems were found.
}
